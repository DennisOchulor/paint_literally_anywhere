...
public class PaletteMenu extends ItemCombinerMenu {
    ...
    public PaletteMenu(int containerId, Inventory inventory, ContainerLevelAccess access) {
        super(CanvasMod.PALETTE_MENU, containerId, inventory, access, createMenuSlotDefinitions());
    ...
    private static ItemCombinerMenuSlotDefinition createMenuSlotDefinitions() {
        return ItemCombinerMenuSlotDefinition.create()
                .withSlot(INPUT_SLOT_INDEX, INPUT_SLOT_START_X, INPUT_SLOT_START_Y, itemStack -> itemStack.is(CanvasMod.PAINT_BRUSH))
    ...
    public void createResult() {
        ...
        if (inputStack.isEmpty() || inputStack.getItem() != CanvasMod.PAINT_BRUSH) {
            resultSlots.setItem(RESULT_SLOT_INDEX, ItemStack.EMPTY);
        }
        else {
            ItemStack resultStack = inputStack.copy();
            resultStack.set(CanvasMod.RGB_COLOR, requestedColor.getRGB());
